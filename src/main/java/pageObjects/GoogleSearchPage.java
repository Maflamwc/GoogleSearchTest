...
public class GoogleSearchPage {
    ...
    private enum EnumWebElement {
        ...
        FIRST_SUGGESTION("Suggestion", "//ul[@role='listbox']/li[1]//div[@class='sbl1 sbl1p']");
    ...
    public String getWebElementXpathByName(String name) {
        return GoogleSearchPage.EnumWebElement.getXpathByWebElementName(name);
    }
    ...
    public void checkFirstResult(String s, String field) {
        Assert.assertTrue(getWebElementByName(field).getText().equals(s));
    }
    ...
    public void checkName(String result){
        Assert.assertTrue(driver.getTitle().equals(result));
    }
